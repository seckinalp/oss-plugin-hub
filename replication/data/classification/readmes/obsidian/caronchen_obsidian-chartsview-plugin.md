...
This is a data visualization plugin for [Obsidian](https://obsidian.md), based on [Ant Design Charts](https://charts.ant.design/). Support plots and graphs. @see [The document generated by Zread](https://zread.ai/caronchen/obsidian-chartsview-plugin)
