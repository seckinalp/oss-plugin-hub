...
const SBOM_DIR = fs.existsSync(path.join(DATA_DIR, 'sbom + osv', 'sbom'))
  ? path.join(DATA_DIR, 'sbom + osv', 'sbom')
  : path.join(DATA_DIR, 'sbom');
const OSV_DIR = fs.existsSync(path.join(DATA_DIR, 'sbom + osv', 'osv-scans'))
  ? path.join(DATA_DIR, 'sbom + osv', 'osv-scans')
  : path.join(DATA_DIR, 'osv-scans');
